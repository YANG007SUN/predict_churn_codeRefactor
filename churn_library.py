...
def perform_eda(dataframe):
    ...
    '''
    # plot histgram
    histgram_val = ['Churn', 'Customer_Age']
...
def encoder_helper(dataframe, category_lst):
    ...
    for col in category_lst:
        ...
        dataframe[f'{col}_Churn'] = temp_list
...
if __name__ == '__main__':
    ...
    X_VARIABLES, Y_VARIABLE = encoder_helper(BANK_DF, CATEGORICAL_LIST)
    # separate train and test data
    X_TRAIN, X_TEST, Y_TRAIN, Y_TEST = perform_feature_engineering(X_VARIABLES, Y_VARIABLE)
    # train the model and outoput predictions results
    Y_TEST_PREDS_RF, Y_TRAIN_PREDS_RF, Y_TEST_PREDS_LR, Y_TRAIN_PREDS_LR = train_models(
    ...
    feature_importance_plot(RFC_MODEL, X_VARIABLES, './images/feature_importance_rf.png')
